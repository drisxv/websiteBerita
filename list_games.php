...
<body>
    <header class="head">
        ...
        <ul class="nav-bar">
            ...
            <li><a href="list_games.php" class="active-button-header">Games</a></li>
            <li>
    ...
    <div class="form_div">
        <form>
            <table border="1">
                ...
                $no = 1;
                $data = mysqli_query($connection, "SELECT * FROM daftar_game");
                while($d = mysqli_fetch_array($data)){
                    ?>
                    <tr>
                        <td><?php echo $no++; ?></td>
                        <td><?php echo $d['game_image']; ?></td>
                        <td><?php echo $d['judul_game']; ?></td>
                        <td><?php echo $d['deskripsi_game']; ?></td>
                        <td><?php echo $d['watching_time_game']; ?></td>
                        <td><?php echo $d['id_genre']; ?></td>
                        <td>
                            <a href="update_game.php?id_game=<?php echo $d['id_game']; ?>">Update</a>
                            <a href="delete_game.php?id_game=<?php echo $d['id_game']; ?>">Delete</a>
                        </td>
                    </tr>
                    <?php
                }
